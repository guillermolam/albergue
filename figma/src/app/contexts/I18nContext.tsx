...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      welcomeText:
        "Experience authentic hospitality on your Camino journey. Our municipal hostel offers comfortable beds, warm meals, and a community of fellow pilgrims.",
  ...
  es: {
    ...
    home: {
      ...
      welcomeText:
        "Experimenta la auténtica hospitalidad en tu viaje por el Camino. Nuestro albergue municipal ofrece camas cómodas, comidas calientes y una comunidad de peregrinos.",
