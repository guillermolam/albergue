...
export const QUICK_LINKS = {
  internal: [
    { id: 'home', pathES: '/', pathEN: '/', labelES: 'Inicio', labelEN: 'Home' },
    { id: 'booking', pathES: '/book', pathEN: '/book', labelES: 'Reservar', labelEN: 'Book Now' },
    { id: 'dashboard', pathES: '/dashboard', pathEN: '/dashboard', labelES: 'Mi Reserva', labelEN: 'My Booking' }
  ],
  legal: [
    { id: 'privacy', pathES: '/privacidad', pathEN: '/privacy', labelES: 'Política de Privacidad', labelEN: 'Privacy Policy' },
    { id: 'terms', pathES: '/terminos', pathEN: '/terms', labelES: 'Términos y Condiciones', labelEN: 'Terms & Conditions' },
    { id: 'cookies', pathES: '/cookies', pathEN: '/cookies', labelES: 'Política de Cookies', labelEN: 'Cookie Policy' },
    { id: 'legal', pathES: '/aviso-legal', pathEN: '/legal-notice', labelES: 'Aviso Legal', labelEN: 'Legal Notice' }
  ],
  external: [
    {
      id: 'camino-info',
