              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
                  ...
                  <input
                    ...
                    required
                  />
                  {errors.firstName && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.firstName}</p>}
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
                  ...
                  <input
                    ...
                    required
                  />
                  {errors.lastName && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.lastName}</p>}
                </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }}>
                  ...
                  <input
                    ...
                    required
                  />
                  {errors.dateOfBirth && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.dateOfBirth}</p>}
                </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }}>
                  <PhoneInput
                    ...
                    required
                  />
                  {errors.phone && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.phone}</p>}
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 doodle-border bg-[#FFF9F0] focus:outline-none focus:ring-2 ${
                      errors.email ? 'focus:ring-[#ED1C24] border-[#ED1C24]' : 'focus:ring-[#00AB39]'
                    }`}
                    style={{ fontFamily: 'Patrick Hand, cursive' }}
                    required
                  />
                  {errors.email && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.email}</p>}
                </motion.div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45 }}>
                  ...
                  <input
                    ...
                    required
                  />
                  {errors.country && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.country}</p>}
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
                  <AddressAutocomplete
                    ...
                    required
                  />
                  {errors.addressLine1 && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.addressLine1}</p>}
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
                    <label className="block text-sm font-medium text-[#5D4E37] mb-2">
                      Postal / ZIP Code <span className="text-[#ED1C24]">*</span>
                    </label>
                    <input
                      type="text"
                      ...
                      required
                    />
                    {errors.postalCode && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.postalCode}</p>}
                  ...
                  <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65 }}>
                    ...
                    <input
                      ...
                      required
                    />
                    {errors.city && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.city}</p>}
                  </motion.div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}>
                  ...
                  <input
                    ...
                    style={{ fontFamily: 'Patrick Hand, cursive' }}
                  />
                  {errors.emergencyContact && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.emergencyContact}</p>}
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.75 }}>
                  <PhoneInput
                    ...
                    required={false}
                  />
                  {errors.emergencyPhone && <p className="mt-1 text-xs text-[#ED1C24] hand-drawn">{errors.emergencyPhone}</p>}
                </motion.div>
              </div>
            </div>
          </div>
