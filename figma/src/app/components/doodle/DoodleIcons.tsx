...
export function MapPinIcon({
  ...
  return (
    ...
    >
      ...
      {/* Squiggly details */}
      <path
        d="M30 45 Q32 48 30 51"
        stroke="#1A1A1A"
        strokeWidth="1.5"
        fill="none"
      />
      <path
        d="M70 45 Q68 48 70 51"
        stroke="#1A1A1A"
        strokeWidth="1.5"
        fill="none"
      />
...
export function ExtremaduraFlag({
  className = "w-12 h-8",
  animate = true,
}: DoodleIconProps) {
  return (
...
export function CarrascalejoFlag({
  className = "w-12 h-8",
  animate = true,
}: DoodleIconProps) {
  return (
