    ...
    >
      ...
      {[...Array(6)].map((_, i) => (
        <motion.rect
          ...
          transition={{ duration: 1 + i * 0.2, repeat: Infinity, delay: i * 0.1 }}
        />
      ))}
    </motion.svg>
  );
...
export function HomeIcon({ className = "w-8 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      ...
      />
      {/* Door */}
      <rect x="42" y="60" width="16" height="20" fill="#8B6914" stroke="#1A1A1A" strokeWidth="2" rx="2" />
      {/* Windows */}
...
export function ClipboardIcon({ className = "w-8 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      <rect x="25" y="20" width="50" height="65" fill="#FFF9F0" stroke="#1A1A1A" strokeWidth="3" rx="4" />
      <rect x="35" y="15" width="30" height="10" fill="#00AB39" stroke="#1A1A1A" strokeWidth="2" rx="3" />
      {/* Lines */}
      <line x1="35" y1="40" x2="65" y2="40" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" />
      <line x1="35" y1="50" x2="65" y2="50" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" />
      <line x1="35" y1="60" x2="55" y2="60" stroke="#1A1A1A" strokeWidth="2" strokeLinecap="round" />
...
export function UtensilsIcon({ className = "w-8 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      ...
      <rect x="28" y="43" width="4" height="37" fill="#4A4A4A" stroke="#1A1A1A" strokeWidth="2" rx="2" />
      
      {/* Spoon */}
      <ellipse cx="70" cy="30" rx="6" ry="9" fill="#4A4A4A" stroke="#1A1A1A" strokeWidth="2.5" />
      <rect x="68" y="35" width="4" height="45" fill="#4A4A4A" stroke="#1A1A1A" strokeWidth="2" rx="2" />
    </motion.svg>
  );
}
...
export function MonumentIcon({ className = "w-8 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      ...
      {/* Roof */}
      <path d="M15 40 L50 20 L85 40 Z" fill="#8B6914" stroke="#1A1A1A" strokeWidth="2.5" strokeLinejoin="round" />
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
      />
      <rect x="32" y="33" width="36" height="28" fill="#E8F5E9" stroke="#1A1A1A" strokeWidth="2" rx="2" />
...
export function BedIcon({ className = "w-8 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      {/* Bed frame */}
      <rect x="15" y="50" width="70" height="25" fill="#D4A574" stroke="#1A1A1A" strokeWidth="3" rx="3" />
      {/* Pillow */}
      <rect x="60" y="42" width="20" height="12" fill="#E8F5E9" stroke="#1A1A1A" strokeWidth="2" rx="2" />
      {/* Mattress detail */}
...
export function CarrascalejoFlag({ className = "w-12 h-8", animate = true }: DoodleIconProps) {
  return (
    ...
    >
      ...
      {/* Tree trunk */}
      <rect x="52" y="36" width="6" height="10" fill="#8B6914" stroke="#1A1A1A" strokeWidth="1.5" rx="1" />
