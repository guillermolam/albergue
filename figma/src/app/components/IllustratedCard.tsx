  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-2xl border-4 border-black/80 p-8 relative overflow-hidden grain-overlay shadow-xl">
        ...
        {/* Hover highlight */}
        <motion.div className="absolute inset-0 bg-gradient-to-br from-[#00AB39]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
    </motion.div>
  );
}
