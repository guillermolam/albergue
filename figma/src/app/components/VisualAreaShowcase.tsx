...
const slides: VisualSlide[] = [
  {
    image: 'https://images.unsplash.com/photo-1711444898752-251183214453?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaWxncmltJTIwY2FtaW5vJTIwc3BhaW58ZW58MXx8fHwxNzY2MjA5NjE3fDA&ixlib=rb-4.1.0&q=80&w=1080',
    title: 'The Camino',
    location: 'Vía de la Plata Route',
    distance: 'You are here'
  },
  {
    image: 'https://images.unsplash.com/photo-1650103134649-5d7621808a1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZXJpZGElMjByb21hbiUyMHJ1aW5zJTIwc3BhaW58ZW58MXx8fHwxNzY2MjA5NjEzfDA&ixlib=rb-4.1.0&q=80&w=1080',
    title: 'Mérida',
    location: 'Roman Ruins & Amphitheater',
    distance: '35 km away'
  },
  {
    image: 'https://images.unsplash.com/photo-1681849780303-d64fe9740b20?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtZWRpZXZhbCUyMHRvd24lMjBzcGFpbnxlbnwxfHx8fDE3NjYyMDk2MTd8MA&ixlib=rb-4.1.0&q=80&w=1080',
    title: 'Medieval Spain',
    location: 'Historic Towns',
    distance: 'Nearby'
  },
  {
    image: 'https://images.unsplash.com/photo-1601210026600-6673ca8d0a40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxleHRyZW1hZHVyYSUyMHNwYWluJTIwbGFuZHNjYXBlfGVufDF8fHx8MTc2NjEzMTM4MXww&ixlib=rb-4.1.0&q=80&w=1080',
    title: 'Extremadura',
    location: 'Natural Landscapes',
    distance: 'All around'
  },
  {
    image: 'https://images.unsplash.com/photo-1764938196166-744e1adb3807?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcGFuaXNoJTIwY291bnRyeXNpZGUlMjBoa2ltaW5n8ZW58MXx8fHwxNzY2MjA5NjE0fDA&ixlib=rb-4.1.0&q=80&w=1080',
    title: 'The Journey',
...
export function VisualAreaShowcase() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Doodle border frame */}
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-30" style={{ transform: 'translateZ(30px)' }}>
          <defs>
          ...
          <rect
            ...
            fill="none" stroke="#1A1A1A" strokeWidth="4" rx="24"
            filter="url(#sketchy-border)"
          />
          <rect
            x="8" y="8" width="calc(100% - 16px)" height="calc(100% - 16px)"
            fill="none" stroke="#00AB39" strokeWidth="2" rx="20"
            opacity="0.8"
          />
        </svg>

        {/* Image carousel with 3D cards */}
        <div className="absolute inset-4 rounded-2xl overflow-hidden" style={{ transformStyle: 'preserve-3d' }}>
                  ...
                  <div className="relative">
                    ...
                    <svg className="absolute inset-0 w-full h-full">
                      <rect
                        ...
                        stroke="#1A1A1A" strokeWidth="2.5" rx="16"
                      />
                    </svg>
                        ...
                        >
                          ...
                          <svg className="absolute inset-0 w-full h-full -left-2 -right-2">
                            <rect
                              ...
                              fill="#00AB39" fillOpacity="0.1"
                              stroke="#00AB39" strokeWidth="2" rx="12"
                            />
                          </svg>
                          
                          <MapPin className="w-4 h-4 text-[#00AB39] relative z-10" strokeWidth={2.5} />
                          <span 
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full">
            ...
            <circle cx="50%" cy="50%" r="35%" fill="none" stroke="#00AB39" strokeWidth="2" opacity="0.6" />
          </svg>
          <ChevronLeft className="relative w-7 h-7 sm:w-8 sm:h-8 text-[#00AB39] mx-auto" strokeWidth={3.5} />
        </motion.button>
        ...
        >
          ...
          <ChevronRight className="relative w-7 h-7 sm:w-8 sm:h-8 text-[#00AB39] mx-auto" strokeWidth={3.5} />
        </motion.button>
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full">
            <rect
              ...
              stroke="#1A1A1A" strokeWidth="2" rx="20"
            />
          </svg>
