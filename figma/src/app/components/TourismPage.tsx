        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Everything you need to know about Carrascalejo and the surrounding
              area
            </p>
          </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                <div className="p-8 text-white">
                  ...
                  <p className="text-white/90">
                    A region of rich history, stunning landscapes, and warm
                    hospitality
                  </p>
                </div>
              </div>
          ...
          <Card className="mt-12 bg-[#00AB39] text-white">
            <CardContent className="p-8 text-center">
              ...
              <p className="mb-6 text-white/90">
                Visit the local tourist office or contact our albergue staff for
