...
export function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  const demoAccounts = [
    { email: 'pilgrim@camino.com', password: 'password', label: language === 'es' ? 'Peregrino' : 'Pilgrim' },
            ...
            >
              ...
              <svg className="absolute inset-0 w-full h-full">
                <rect
                  ...
                  fill="white"
                  stroke="#1A1A1A" strokeWidth="3" rx="20"
                />
                <rect
                  x="8" y="8" width="calc(100% - 16px)" height="calc(100% - 16px)"
                  fill="none"
                  stroke="#00AB39" strokeWidth="2" rx="18"
                  opacity="0.6"
                />
              </svg>
              ...
              <div className="relative p-8">
                ...
                >
                  <svg className="absolute inset-0 w-full h-full">
                    <circle cx="20" cy="20" r="18" fill="#f5f5f5" stroke="#1A1A1A" strokeWidth="2" />
                  </svg>
                  <X className="relative w-5 h-5 text-[#1A1A1A] group-hover:text-[#ED1C24] transition-colors" strokeWidth={2.5} />
                </motion.button>
                ...
                <div className="text-center mb-8">
                  ...
                  >
                    <UserIcon className="w-16 h-16 text-[#00AB39]" strokeWidth={2} />
                  </motion.div>
                  <h2 
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="relative">
                      <svg className="absolute inset-0 w-full h-full pointer-events-none">
                        <rect
                          ...
                          fill="white"
                          stroke="#1A1A1A" strokeWidth="2" rx="12"
                        />
                      </svg>
                      <div className="relative flex items-center">
                        <Mail className="absolute left-3 w-5 h-5 text-gray-400" strokeWidth={2} />
                        <input
                          type="email"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative flex items-center">
                        <Lock className="absolute left-3 w-5 h-5 text-gray-400" strokeWidth={2} />
                        <input
                        ...
                        >
                          {showPassword ? (
                            <EyeOff className="w-5 h-5 text-gray-400 hover:text-[#00AB39] transition-colors" strokeWidth={2} />
                          ) : (
                            <Eye className="w-5 h-5 text-gray-400 hover:text-[#00AB39] transition-colors" strokeWidth={2} />
                          )}
                        </button>
                      </div>
                    </div>
                  ...
                  >
                    <svg className="absolute inset-0 w-full h-full pointer-events-none">
                      <motion.rect
                        ...
                        stroke="#1A1A1A" strokeWidth="2.5" rx="12"
                ...
                <div className="mt-6 pt-6 border-t-2 border-dashed border-gray-300">
                  <p 
                    ...
                    style={{ fontFamily: 'Patrick Hand, cursive' }}
                  >
                    {language === 'es' ? 'Cuentas de prueba:' : 'Demo accounts:'}
                  </p>
                      ...
                      >
                        <svg className="absolute inset-0 w-full h-full pointer-events-none">
                          <rect
                            ...
                            fill="white"
                            stroke="#00AB39" strokeWidth="1.5" rx="8"
                          />
                        </svg>
                        <span 
