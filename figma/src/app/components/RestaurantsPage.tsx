  ...
  const restaurants = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1710886480727-cd0a013fd6e0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcGFuaXNoJTIwcmVzdGF1cmFudCUyMGludGVyaW9yfGVufDF8fHx8MTc2NjEzMTM4MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    },
    {
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <span className="text-[#00AB39] text-sm">{restaurant.priceRange}</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    ...
                    <div className="pt-2 border-t">
                      <p className="text-sm">
                        ...
                        <span className="text-[#00AB39]">{restaurant.specialties}</span>
                      </p>
                    </div>
                  </CardContent>
                </Card>
