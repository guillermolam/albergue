...
export function VisitsPage() {
  const freeTours = [
    ...
    },
    {
      ...
      distance: "5 km loop",
      description:
        "A beautiful circular walk that takes you through the countryside surrounding the town",
      highlights: [
        "Olive groves",
        "Panoramic views",
        "Wildlife spotting",
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Explore the beauty and history of Carrascalejo and its
              surroundings
            </p>
          </div>
                ...
                <Card className="max-w-2xl mx-auto bg-blue-50 border-blue-200">
                  <CardContent className="p-6">
                    <p className="text-sm text-blue-900">
                      <strong>Booking Information:</strong> Guided tours must be
                      booked at least 48 hours in advance. Contact the albergue
                      reception or call +34 123 456 789 to arrange your tour.
                    </p>
                  </CardContent>
                </Card>
              </div>
