          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {currentStep === 4 && (
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="credentialNumber">
                      Pilgrim Credential Number
                    </Label>
                    <Input
                      id="credentialNumber"
                      value={formData.credentialNumber}
                      onChange={(e) =>
                        updateFormData("credentialNumber", e.target.value)
                      }
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-900">
                      <strong>Note:</strong> A valid Pilgrim Credential is
                      required to stay at our albergue. If you don't have one
                      yet, you can obtain it at various starting points along
                      the Camino.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  {formData.idFile && (
                    <div className="mt-4 p-4 bg-green-50 border-2 border-[#00AB39] rounded-lg doodle-border">
                      <p className="text-sm text-[#00AB39] font-medium mb-2">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                      ...
                      <button
                        onClick={() =>
                          updateFormData("paymentMethod", "transfer")
                        }
                        className={`p-6 border-2 rounded-lg flex flex-col items-center gap-3 transition-all ${
              ...
              {currentStep === 7 && (
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-900">
                      By confirming this booking, you agree to the albergue's
                      terms and conditions. You will receive a confirmation
