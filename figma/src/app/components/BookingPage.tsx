      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-5">
        <svg className="w-full h-full">
          <pattern id="doodlePattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            <path d="M10,10 Q20,5 30,10 T50,10" stroke="#5D4E37" strokeWidth="2" fill="none" />
            <circle cx="70" cy="30" r="5" stroke="#00AB39" strokeWidth="2" fill="none" />
            <path d="M20,60 L30,70 L20,80" stroke="#D4A574" strokeWidth="2" fill="none" />
          </pattern>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        ...
        >
          <div className="text-center mb-16">
            ...
            <h1 className="mb-4 text-5xl md:text-6xl sketch-title">Book Your Stay</h1>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Select your preferred <span className="highlight-doodle">beds and dates</span>, then complete the booking form
            </p>
          ...
          {!showForm ? (
            ...
            <>
              ...
              <div className="mt-6">
                <BookingForm selectedBeds={selectedBeds} checkInDate={checkInDate} />
              </div>
            </>
          )}
        </motion.div>
