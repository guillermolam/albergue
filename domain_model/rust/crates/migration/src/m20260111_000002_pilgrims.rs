        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Pilgrims::FirstNameEncrypted)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Pilgrims::LastName1Encrypted)
                            .text()
                            .not_null(),
                    )
                    .col(ColumnDef::new(Pilgrims::LastName2Encrypted).text().null())
                    .col(
                        ColumnDef::new(Pilgrims::BirthDateEncrypted)
                            .text()
                            .not_null(),
                    )
                    .col(ColumnDef::new(Pilgrims::DocumentType).string().not_null())
                    .col(
                        ColumnDef::new(Pilgrims::DocumentNumberEncrypted)
                            .text()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Pilgrims::AddressStreetEncrypted)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Pilgrims::AddressStreet2Encrypted)
                            .text()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(Pilgrims::AddressCityEncrypted)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Pilgrims::AddressPostalCode)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(Pilgrims::AddressProvince).string().null())
                    .col(
                        ColumnDef::new(Pilgrims::AddressMunicipalityCode)
                            .string()
                            .null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Pilgrims::DataRetentionUntil)
                            .timestamp()
                            .null(),
                    )
