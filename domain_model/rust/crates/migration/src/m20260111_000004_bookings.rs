        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Bookings::NumberOfNights)
                            .integer()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Bookings::EstimatedArrivalTime)
                            .string()
                            .null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(Bookings::ReservationExpiresAt)
                            .timestamp()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Bookings::PaymentDeadline)
                            .timestamp()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Bookings::AutoCleanupProcessed)
                            .boolean()
                            .null(),
                    )
