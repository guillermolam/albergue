...
notifications.get("/", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get notifications: ${String(error)}`,
    });
  }
});
...
notifications.get("/:id", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get notification: ${String(error)}`,
    });
  }
});
...
notifications.get("/pilgrim/:pilgrimId", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(500, {
      message: `Failed to get notifications by pilgrim: ${String(error)}`,
    });
  }
});
...
notifications.get("/pending", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get pending notifications: ${String(error)}`,
    });
  }
});
...
notifications.get("/stats", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get notification statistics: ${String(error)}`,
    });
  }
});
