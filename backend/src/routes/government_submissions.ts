...
governmentSubmissions.get("/", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get government submissions: ${String(error)}`,
    });
  }
});
...
governmentSubmissions.get("/:id", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get government submission: ${String(error)}`,
    });
  }
});
...
governmentSubmissions.get("/booking/:bookingId", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(500, {
      message: `Failed to get government submissions by booking: ${String(error)}`,
    });
  }
});
...
governmentSubmissions.get("/pending", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get pending submissions: ${String(error)}`,
    });
  }
});
...
governmentSubmissions.get("/stats", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get government submission statistics: ${String(error)}`,
    });
  }
});
