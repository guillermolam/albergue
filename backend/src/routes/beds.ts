...
beds.get("/", async (c: Context) => {
  try {
    const { page, pageSize, orderBy, orderDirection, ...filters } =
      c.req.query();
    ...
    throw new HTTPException(500, {
      message: `Failed to get beds: ${String(error)}`,
    });
  }
});
...
beds.get("/:id", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get bed: ${String(error)}`,
    });
  }
});
...
beds.get("/occupied", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get occupied beds: ${String(error)}`,
    });
  }
});
...
beds.get("/maintenance", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get maintenance beds: ${String(error)}`,
    });
  }
});
...
beds.get("/stats", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get bed statistics: ${String(error)}`,
    });
  }
});
...
beds.get("/room/:roomNumber", async (c: Context) => {
  try {
    ...
    if (isNaN(roomNumber))
      throw new HTTPException(400, { message: "Invalid room number" });
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(500, {
      message: `Failed to get beds by room: ${String(error)}`,
    });
  }
});
...
beds.get("/type/:roomType", async (c: Context) => {
  try {
    ...
    throw new HTTPException(500, {
      message: `Failed to get beds by type: ${String(error)}`,
    });
  }
});
...
beds.post("/", async (c: Context) => {
  try {
    ...
    throw new HTTPException(400, {
      message: `Failed to create bed: ${String(error)}`,
    });
  }
});
...
beds.post("/batch", async (c: Context) => {
  try {
    ...
    throw new HTTPException(400, {
      message: `Failed to create beds batch: ${String(error)}`,
    });
  }
});
...
beds.put("/:id", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(400, {
      message: `Failed to update bed: ${String(error)}`,
    });
  }
});
...
beds.patch("/:id/reserve", async (c: Context) => {
  try {
    ...
    if (!success)
      throw new HTTPException(409, { message: "Bed unavailable or not found" });
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(400, {
      message: `Failed to reserve bed: ${String(error)}`,
    });
  }
});
...
beds.patch("/:id/release", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(400, {
      message: `Failed to release bed: ${String(error)}`,
    });
  }
});
...
beds.post("/cleanup-expired", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(500, {
      message: `Failed to cleanup expired reservations: ${String(error)}`,
    });
  }
});
...
beds.delete("/:id", async (c: Context) => {
  try {
    ...
    if (error instanceof HTTPException) throw error;
    throw new HTTPException(400, {
      message: `Failed to soft delete bed: ${String(error)}`,
    });
  }
});
