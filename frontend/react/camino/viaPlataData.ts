 ...
 * approach as domain_model/seed/geocode.mjs), as [lng, lat] for MapLibre.
 */
...
export const EL_CARRASCALEJO_COORDS: [number, number] = [-6.3371905, 39.0223673];
